...
queries. `serverSafe:true` → forced `partial` coverage. See [[09-Audit/Bugs#f-109]], [[09-Audit/Bugs#f-208]].
...
## See also
[[_index|Quarantine register]] · [[02-Adapters/Extension-Adapters#ena]] · [[10-Sprints/Index|v0.38 sprint]]
