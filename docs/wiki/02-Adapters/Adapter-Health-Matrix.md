...
**Blast radius:** Every search on the production system is artificially discounted because 3 of ~34 adapters always fail. Fix: remove SCIELO, OPENNEURO, ENA from the `ADAPTERS` array (keeping the files). See [[09-Audit/Bugs#f-109]] [[09-Audit/Bugs#f-110]] [[09-Audit/Bugs#f-107]].
...
See [[09-Audit/Bugs]] for full detail on each.

## See also

[[02-Adapters/Adapter-Architecture]] · [[02-Adapters/Core-Adapters]] · [[02-Adapters/Extension-Adapters]] · [[09-Audit/Bugs]] · [[09-Audit/Duplication-and-Reuse]]
