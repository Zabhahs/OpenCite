...
The six heritage routes duplicate normalization logic that exists in corresponding client adapters. See [[09-Audit/Duplication-and-Reuse#r-401]].
...
- **Reuse:** Six heritage routes re-implement normalization logic that overlaps with client adapters. See [[09-Audit/Duplication-and-Reuse#r-401]].

## See also

[[04-Backend-API/Proxy]] · [[04-Backend-API/Shared-Modules#serverkeysjs]] · [[02-Adapters/Adapter-Architecture]] · [[09-Audit/Security]]
