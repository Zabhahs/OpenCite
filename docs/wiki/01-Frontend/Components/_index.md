...
**IA source label:** `result.citedBy` is labeled "downloaded" instead of "cited" when `result.source === "IA"` — acknowledges the IA download-count-as-citedBy defect (D1 from v0.36 diagnostic). See [[09-Audit/Bugs#f-001]].
...
[[01-Frontend/UI-Map]] · [[01-Frontend/State-Flow]] · [[01-Frontend/Hooks]] · [[09-Audit/Duplication-and-Reuse]] · [[09-Audit/Bugs]]
