...
adapter_id: MET
---
<!-- AUTO-GENERATED from docs/wiki/02-Adapters/capability-dossiers/MET.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
