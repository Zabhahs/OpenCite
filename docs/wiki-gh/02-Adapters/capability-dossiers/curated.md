...
pre_audit_tier: A
---
<!-- AUTO-GENERATED from docs/wiki/02-Adapters/capability-dossiers/curated.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
...
Identical to OpenAlex. See [openalex](openalex.md) §2.
...
See [openalex](openalex.md) §3 for full field table.
...
Author-name pollution control: same as OPENALEX — `title_and_abstract.search` structurally impossible to pollute. See [openalex](openalex.md) §4.
...
None. Same as OPENALEX. See [openalex](openalex.md) §6.

---

## §7 Discipline / Subject Tags

Same as OPENALEX. See [openalex](openalex.md) §7.

---

## §8 Native Relevance & Scoring

Same as OPENALEX — `relevance_score` field returned via `sort=relevance_score:desc`. See [openalex](openalex.md) §8.
...
Identical to OPENALEX — shares the same `settings.openAlexKey` or `settings.crossrefEmail` for polite pool. Same 10,000 req/day free tier. See [openalex](openalex.md) §10.

---

## §11 Dirty-Data / Parsing Hazards

Identical to OPENALEX — same shared `parseOpenAlexWork()` parser. See [openalex](openalex.md) §11.
...
CURATED inherits all under-exploited OpenAlex fields (see [openalex](openalex.md) §12). Additional considerations:
