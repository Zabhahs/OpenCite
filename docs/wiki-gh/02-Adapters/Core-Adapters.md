...
tags: [adapter, core]
---
<!-- AUTO-GENERATED from docs/wiki/02-Adapters/Core-Adapters.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
...
Delegates result parsing entirely to `parseOpenAlexWork()` from `_shared/parseOpenAlex.js`. See [Adapter-Architecture](Adapter-Architecture.md#parseopenalexwork).
