...
---
<!-- AUTO-GENERATED from docs/wiki/02-Adapters/Extension-Adapters.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
...
Three adapters are confirmed dead in production: [openneuro](#openneuro), [ena](#ena), [scielo](#scielo). See [Adapter-Health-Matrix](Adapter-Health-Matrix.md) and [Bugs](../09-Audit/Bugs.md).
...
- **Findings:** [F-104] [F-105] [F-106] [F-107] [F-108] [F-109] [F-110] [F-111] [F-112] [F-113] [F-114] [F-115] [F-116]
- **Reuse:** Many adapters duplicate the `try{direct-fetch}catch{proxiedFetch}` pattern (Northwestern, ONB, BnF) — see [Duplication-and-Reuse](../09-Audit/Duplication-and-Reuse.md#r-102).
...
[Adapter-Architecture](Adapter-Architecture.md) · [Core-Adapters](Core-Adapters.md) · [Adapter-Health-Matrix](Adapter-Health-Matrix.md) · [Bugs](../09-Audit/Bugs.md) · [Duplication-and-Reuse](../09-Audit/Duplication-and-Reuse.md)
