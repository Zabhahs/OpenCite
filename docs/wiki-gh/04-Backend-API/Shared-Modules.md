...
---
<!-- AUTO-GENERATED from docs/wiki/04-Backend-API/Shared-Modules.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
...
**See:** [Search-Endpoint](Search-Endpoint.md#publicresultjs--debugresultjs)
...
**Duplication note (R-400):** Identical format logic to `src/lib/log.js` — two implementations of the same structured log format. See [Duplication-and-Reuse](../09-Audit/Duplication-and-Reuse.md#r-400).
...
**See:** [Billing-Credits](../05-Billing/Billing-Credits.md#plans) for the full plan table and credit pack definitions.
...
- **Reuse:** `api/_shared/log.js` duplicates `src/lib/log.js` — see [Duplication-and-Reuse](../09-Audit/Duplication-and-Reuse.md#r-400).

## See also

[Search-Endpoint](Search-Endpoint.md) · [Billing-Credits](../05-Billing/Billing-Credits.md) · [Auth-Sessions](Auth-Sessions.md) · [Data-Layer](../07-Data-Layer/Data-Layer.md) · [Security](../09-Audit/Security.md)
