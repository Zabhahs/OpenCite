...
---
<!-- AUTO-GENERATED from docs/wiki/01-Frontend/App-Shell.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
...
- **Reuse:** `isAdmin()` is called twice (App.jsx + AdminConsole.jsx); `showAdminConsole` re-implements a poor man's router — see [Duplication-and-Reuse](../09-Audit/Duplication-and-Reuse.md).
