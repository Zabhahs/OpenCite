...
---
<!-- AUTO-GENERATED from docs/wiki/03-Search-Pipeline/Semantic-Rerank.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
...
- **Reuse:** client-only by design (worker API unavailable server-side). See [Duplication-and-Reuse](../09-Audit/Duplication-and-Reuse.md#r-202).
...
[RRF-Fusion](RRF-Fusion.md) · [Ranking-Scoring](Ranking-Scoring.md) · [Known-Defects](Known-Defects.md#f-205) · [Duplication-and-Reuse](../09-Audit/Duplication-and-Reuse.md#r-202)
