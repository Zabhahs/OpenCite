...
---
<!-- AUTO-GENERATED from docs/wiki/03-Search-Pipeline/Citations.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
...
[Adapter-Architecture](../02-Adapters/Adapter-Architecture.md) · [Ranking-Scoring](Ranking-Scoring.md)
