...
---
<!-- AUTO-GENERATED from docs/wiki/03-Search-Pipeline/Ranking-Scoring.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
...
| `applyConfidenceGate(scored, meaningful)` | fn | Low-confidence fallback — see [Confidence-Gate](Confidence-Gate.md) |
| `hasContentMatch(result, terms)` | fn | Content-scope predicate (author-bleed filter) — see [Confidence-Gate](Confidence-Gate.md) |
...
- Imported by: [Confidence-Gate](Confidence-Gate.md) (re-exports `applyConfidenceGate`, `hasContentMatch`), [RRF-Fusion](RRF-Fusion.md) (`fuseRanks` consumes BM25F ranks), `hooks.useSearch`, `api.search`
...
- **Reuse:** pure JS, runtime=shared — see [Duplication-and-Reuse](../09-Audit/Duplication-and-Reuse.md#r-200).
...
[RRF-Fusion](RRF-Fusion.md) · [Semantic-Rerank](Semantic-Rerank.md) · [Confidence-Gate](Confidence-Gate.md) · [Known-Defects](Known-Defects.md) · [Synonyms-Vocab](Synonyms-Vocab.md) · [Bugs](../09-Audit/Bugs.md#f-200)
