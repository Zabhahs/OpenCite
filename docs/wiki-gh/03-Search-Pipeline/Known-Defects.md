...
**Status: FIXED on the CLIENT path only; OPEN on the server — see [f-209](#f-209).** Verified 2026-06-08:
...
| F-205 | Semantic signal absent server-side (API/MCP) | Med | **SPIKE-COMPLETE** | spike: [Semantic-Server-Spike](Semantic-Server-Spike.md) — prototype deferred to v0.43+ |
