...
---
<!-- AUTO-GENERATED from docs/wiki/11-Legal/Terms-of-Service.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
...
> draft. See [Legal-Overview](Legal-Overview.md) for the go-live checklist.
...
(see [Billing-Credits](../05-Billing/Billing-Credits.md)).
...
- The Service runs on **prepaid credits** — entitlements to make searches, not currency or a deposit.
  ...
  [Billing-Credits](../05-Billing/Billing-Credits.md).
...
- [Legal-Overview](Legal-Overview.md) — go-live legal checklist (this note is item **L1**)
- [`LICENSE`](../../../LICENSE) — OpenCITE Source-Available License v1.0
- [Billing-Credits](../05-Billing/Billing-Credits.md) — credit/rate-limit mechanics the ToS describes
