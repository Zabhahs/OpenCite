<!-- AUTO-GENERATED from docs/wiki/99-Archive/architecture_report_v0_23.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
...
> Last updated: v0.23 — Language normalization, art types, Topics facet, OA filter, museum/OpenAlex enrichment
---
## Project overview
...
| `src/constants/app.js` | `APP_VERSION = "v.23"` |
...
---
## UnifiedResult schema (v0.23 — unchanged from v0.17)
```js
// Required
title:      string
id:         string
...
│   │   │   ├── base.js
│   │   │   ├── normalize.js
│   │   │   ├── parseOpenAlex.js              ← [MODIFIED v0.23] topics[].display_name + field.display_name in keywords
│   │   │   ├── proxy.js
│   │   │   └── xmlUtils.js
│   │   ├── core/
│   │   │   ├── doaj.js
...
│   ├── hooks/
│   │   ├── useEagleTooltip.js
│   │   ├── useFilters.js                     ← [MODIFIED v0.23] normalizeLanguage(), keyword filter, oaOnly filter
│   │   ├── useHistory.js
│   │   ├── useLibrary.js
│   │   ├── useSearch.js
│   │   ├── useSettings.js
...
- **SSOT discipline.** Scoring: `src/lib/scoring.js`. Filtering: `src/hooks/useFilters.js`. Cross-adapter dedup: `useSearch.js`. Filter UI: `FilterBar.jsx`. Language normalization: `src/lib/langNormalize.js`.
- **FilterBar derives options from live results.** Type pills, LangDropdown, and Topics facet are only shown when those values actually appear in current results. No hardcoded option lists.
