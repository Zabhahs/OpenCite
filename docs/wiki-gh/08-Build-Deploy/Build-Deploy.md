...
---
<!-- AUTO-GENERATED from docs/wiki/08-Build-Deploy/Build-Deploy.md by scripts/wiki/to-github.mjs — do not edit here. Edit the Obsidian source in docs/wiki/ and re-run: node scripts/wiki/to-github.mjs -->
...
1. **`node scripts/migrate.mjs`** — P3005-safe migration runner (always exits 0). See [Data-Layer](../07-Data-Layer/Data-Layer.md#migratejs----p3005-safe-runner). Uses `POSTGRES_URL_NON_POOLING` for DDL-safe direct connection.
...
[Data-Layer](../07-Data-Layer/Data-Layer.md) · [MCP-Server](../06-MCP-Server/MCP-Server.md) · [Search-Endpoint](../04-Backend-API/Search-Endpoint.md) · [home](../home.md)
